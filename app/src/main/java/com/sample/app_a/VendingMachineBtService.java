...
public class VendingMachineBtService {
    private static final String TAG = "MY_APP_DEBUG_TAG" + "bhaskar";
    private Handler mHandler; // handler that gets info from Bluetooth service

    private static final String VENDING_MACHINE_BT_SERVICE_NAME = "vending_service";
    private static final UUID VENDING_MACHINE_BT_SERVICE_UUID = UUID.fromString("523291af-6ecd-4ab6-8b47-113e0de54039");
    ...
    public VendingMachineBtService(Context context, Handler handler){
...
/*        if (mInsecureAcceptThread != null) {
    ...
    private void connectionFailed() {
        ...
        VendingMachineBtService.this.start();
    }
